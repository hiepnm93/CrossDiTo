...
PAGES = {
    "home":     ("/",         "CrossDiTo",                   "home",     ""),
    "files":    ("/files",    "Files - CrossDiTo",           "files",    '  <script src="/js/jszip.min.js"></script>'),
    "settings": ("/settings", "Settings - CrossDiTo Reader", "settings", ""),
    "fonts":    ("/fonts",    "Fonts - CrossDiTo",           "fonts",    ""),
}
...
if __name__ == "__main__":
    ...
    print(f"CrossDiTo web preview: http://localhost:{port}  (Ctrl+C to stop)")
    try:
        httpd.serve_forever()
